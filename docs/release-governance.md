...
| --- | --- | --- | --- | --- | --- | --- |
| `rdfs-sparql-first-closure` | `dev-2026-07-nightly:ab0131c` | `daa3505` (`v0.31.1`) | `c62ebd8` (`v0.3.0`) | `fcba9b6` (`v0.1.1`) | `verify-rdfs-sparql.sh` | Release-qualified local integration path |
...
[Garden CI run 30079510562](https://github.com/crapthings/odin-garden/actions/runs/30079510562).
