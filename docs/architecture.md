...
| Pinned closure-to-query integration | Met | Garden pins released `odin-rdf v0.31.1`, `odin-reasoner v0.3.0`, and `odin-sparql v0.1.1`; [CI run 30079510562](https://github.com/crapthings/odin-garden/actions/runs/30079510562) verifies the tags and passes closure, lifecycle, graph-scope, limit, blank-node, live-view equivalence, and adopted-snapshot cases. |
